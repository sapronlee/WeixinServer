angular.module('weixin.controllers').controller 'WeixinMessagesController', ['$scope', '$q', 'Message', 'ngTableParams', 'BreadCrumbsService', ($scope, $q, Message, ngTableParams, BreadCrumbsService)->
  # 设置Breadcrumbs
